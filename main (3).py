...
print text[0:5] # Выводит подстроку text от 8 символа до 5 (включительно с нулевым, исклю
print text[4:10] # Выведет строку от 4 символа до 10 (включая четвертый, исключая 10) 8
